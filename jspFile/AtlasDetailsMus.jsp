...
<body>
<input name="ats"  id="ats" type="hidden" value=<%=request.getParameter("ats") %> >
                    ...
                    <div class="panel panel-success" id="summary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" style="font-size:16px;margin-top:50px;">
                                    <tbody>
                                    	<tr>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td class="summary-td1"> Data Set Number</td>
                                            <td id="dataset_number">5</td>
                                        </tr>
                                        <tr>
...
<!--                 ///////////////// marker  -->
				<div class="col-md-12">
                    ...
                    <div class="panel panel-success" id="marker">
                        <div class="panel-heading">
                            <strong style="font-size:20px;color:black">Atlas Markers</strong>
                        </div>
                        <div class="panel-body">
                            <div id="markerTable" class="col-md-12">
					            ...
					            <div id="marker_cluster_marker_violin" class="col-md-7 ">
					            	 <table style="margin-top:50px;margin-bottom:10px;" >
	                                	<tr>
	                                		<td class="td1">Select a marker</td>
...
<!-- ////////////// cel cell end -->
    ...
    <script src="js/AtlasDetailsMus.js"></script>
</body>
</html>